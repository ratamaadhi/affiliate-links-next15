  ...
  return (
    <PageWrapper breadcrumbs={breadcrumbs}>
      <main className="flex flex-col h-full gap-y-2 bg-muted/50 rounded-lg p-4">
        <div className="flex gap-2 md:w-max w-full rounded-lg px-4 py-2 bg-background shadow border border-muted mb-4 relative overflow-hidden">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between gap-6">
          ...
          <div className="md:w-1/2 w-full h-96 flex gap-2 bg-muted/50 rounded-lg px-4 py-2 shadow border border-muted">
