...
export async function GET(request) {
  ...
  const cacheKey = `link-meta:${targetUrl}`
...
async function enhanceMetadata(meta, page) {
...
async function getImageMetadata(currentImage, page) {
...
async function getTitleMetadata(currentTitle, page) {
...
async function getDescriptionMetadata(currentDescription, page) {
